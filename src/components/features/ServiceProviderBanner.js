    ...
    >
      <div className="w-full bg-cover bg-center relative text-white rounded-lg p-6  lg:px-12">
        <div className="flex flex-col items-start justify-center h-full">
          <h2 className="text-[10px] sm:text-xs max-sm:tracking-tighter md:text-[12px] lg:text-base sm:font-extrabold lg:mt-8">
            Earn 5% of the amount your friends spend, for life
          </h2>
          <p className="opacity-80 sm:mb-6 text-[10px] md:mb-2 sm:text-sm ">
