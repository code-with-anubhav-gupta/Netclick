    ...
    <section className="bg-[url('/assets/image/background.jpg')] bg-cover bg-center text-white max-w-7xl mx-auto px-4 sm:px-6 md:px-10 rounded-4xl overflow-hidden relative">
      <div className="flex flex-col-reverse md:flex-row items-center">
        <div className="w-full md:w-1/2 p-6 sm:p-8 md:p-10 flex flex-col justify-center text-center md:text-left">
          ...
          <div className="bg-white rounded-lg md:rounded-4xl flex flex-col sm:flex-row items-stretch overflow-hidden w-full">
            <div className="p-2 flex flex-col sm:flex-row justify-center items-center gap-2 w-full">
              ...
              <div className="bg-gray-100 p-2 rounded w-full flex justify-around items-center sm:w-auto">
                <div className="relative w-full">
                  <div className="pointer-events-none absolute md:-right-5 inset-2 flex items-center justify-end max-sm:pr-5 md:mt-0.5 ">
              ...
              {/* Input and Search Button Wrapper */}
              <div className="flex flex-col max-sm:w-full sm:flex-row sm:items-center sm:gap-2 w-full">
                <div className="flex max-sm:flex-row max-sm:items-center w-full">
                  <input
                    type="text"
                    placeholder="Search for Service"
                    className="flex-1 py-2 outline-none text-gray-800 rounded w-full max-sm:placeholder:text-start max-sm:placeholder:px-4 md:placeholder:text-start"
                    value={searchTerm}
                    onChange={(e) => setSearchTerm(e.target.value)}
                    name="search"
                    id="search"
                  />
                  <button className="bg-[#DDA25F] text-white h-8 w-8 mr-6 md:mt-1 md:mr-2 flex items-center justify-center rounded-full cursor-pointer">
                    <svg
