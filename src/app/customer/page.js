...
export default function Page() {
  ...
  const profileView = (
    <div className="min-h-screen bg-zinc-300  flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full bg-white text-black rounded-3xl shadow-lg overflow-hidden">
        ...
        <div className="pt-12 pb-8 px-6">
          ...
          <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    ...
                    />
                    <div className={`w-11 h-6 bg-gray-200 rounded-full transition-colors duration-300 ease-in-out ${notifications.newMessages ? 'bg-green-800' : 'bg-gray-300'}`}></div>
                    <div className={`absolute left-0.5 top-0.5 bg-white w-5 h-5 rounded-full shadow transform transition-transform duration-300 ease-in-out ${notifications.newMessages ? 'translate-x-5' : 'translate-x-0'}`}></div>
                  </label>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    ...
                    />
                    <div className={`w-11 h-6 bg-gray-200 rounded-full transition-colors duration-300 ease-in-out ${notifications.newCourse ? 'bg-green-800' : 'bg-gray-300'}`}></div>
                    <div className={`absolute left-0.5 top-0.5 bg-white w-5 h-5 rounded-full shadow transform transition-transform duration-300 ease-in-out ${notifications.newCourse ? 'translate-x-5' : 'translate-x-0'}`}></div>
                  </label>
                </div>
              </div>
            </div>
            <hr className='border-t border-gray-300 mb-2' />
            <div className="space-y-2">
              <div className="text-gray-500 cursor-pointer hover:text-gray-700">Terms And Conditions</div>
              <div className="text-gray-500 cursor-pointer hover:text-gray-700">Privacy Policy</div>
              <div className="text-gray-500 cursor-pointer hover:text-gray-700">Help</div>
            </div>
          </div>
          <button
              ...
              <div className="flex items-center border-b-2 border-gray-200">
                ...
                <input
                  type="text"
                               ...
                               onChange={handleEditChange}
                               placeholder="Postal Code"        className="w-full py-2 focus:outline-none"
                />
              </div>
              <div className="flex items-center border-b-2 border-gray-200">
                <span className="text-gray-500 mr-2">
                ...
                type="number"
                              ...
                              onChange={handleEditChange}
                              placeholder="Date of Birth"        className="w-full py-2 focus:outline-none"
                />
              </div>
            <select
              name="service"
